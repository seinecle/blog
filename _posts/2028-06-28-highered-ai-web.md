...
# Previous tech shocks on highered: the web, big data, and MOOCs
...
The democratization of content production by independent individuals, channels of content distribution and diversification of learning habits (shorter attention spans, mobile first, screen-based...). Will highered orgs be sidelined, since knowledge has become available for free, easily and from anywhere?

2. [2010 and forward] **Big data and data science**

Personalized learning will be achieved through the analysis of vast quantities of personal data to create individual learning paths. Is the classroom with standardized teaching at the group-level still relevant? Is the professor relevant as a designer of courses and producer of pedagogical content, when this content can be sourced, curated and assembled at scale from online platforms? 
...
Given the relatively weak impact the web has had on the core experience of learning and teaching, a comparison betweeen AI and the web is important. **Maybe AI will reveal to be as important as the web, but with similarly weak transformative effects on pedagogy itself?**

I think AI is a shock of a different kind. Let's state what I consider to be indisputable facts. The impact of AI is:
...
Let's review the 4 dimensions**:

## Profound shock: web and AI alike?

Internet and the web were definitely "profound" in nature, because they opened a space where new content and experiences could be created with few barriers of cost, distance or authority, supplementing and interconnecting with the offline world. This created an explosion of digital services and transformed the offline world. But AI is a layer deeper. It does not merely expand the space where humans can express and develop their creativity: it expands creativity itself.

To come back to higher education: the web has offered students access to new kinds of resources to learn, which made easier for them to develop the corresponding skill. AI goes deeper: AI can readily generate in a few seconds what a skilled student would have created in a few hours or days. One can legitimately wonder: should the student continue to learn and acquire the skill? This question is radically new and was not opened up by the emergence of the web. 

## Broad shock: web and AI alike?

The web can be said to be a very "broad" technology: it touches everything, in particular since we carry smartphones all day long. But there again, AI is broad at a more fundamental level. LLMs have the capacity do emulate everything we ask them to be. Just like digital devices are free from analogical mecanisms, LLMs are not bound to following a digital program ([the argument is developed there](https://nocodefunctions.com/blog/chatgpt-consequences/)). This is "broad" in a sense that we never envisioned before: the emergence of a kind of omnipotent device.

## Systemic shock: web and AI alike?

The development of Internet and the web at scale has had profound environmental, geopolitical and societal consequences ([a](https://www.dukeupress.edu/finite-media), [b](https://yalebooks.yale.edu/book/9780300234176/twitter-and-tear-gas/), [c](https://www.hbs.edu/faculty/Pages/item.aspx?num=56791)). Yet it seems that AI has a potential for even more disruption. Developing and running AI models necessitates data centers which consume large amounts of electricity, rare-earth materials, and water. The planned capacity of data centers to be created in the next decade is widely commented as putting other use at risk. AI models could also create mass unemployment, especially when it used to augment robots with smart behavior, performing better and cheaper than a human operator would do (taxi driver, factory worker ...).
