...
---
Is ChatGPT a form of "Artificial General Intelligence" (AGI) or not? I argue that, yes indeed. Keep reading.
...
The emergence of an AGI would have happended as a series of incremental steps over a few years. We should acknowledge the fact that some early forms of AGI have emerged, and act accordinly in terms of education, health and safety, etc. 

So the question is indeed not trivial.

# Is ChatGPT an AGI? The counter arguments
The consensus is that AGI will arise in decades, or never. "Today" is not an option:
...
What is an AGI? The definition is muddy. The Wikipedia article, but also everything I read about AI and AGI, list these criteria:
