...
Instead, what points 1 to 5 above indicate is that AGI has already emerged, by all reasonable definitions. LLMS are generalists, mimic human intelligence, mimic human subjectivity, can be made autonomous, and their capacity to be self aware or not is a moot issue. And what comes to fore in not an existential threat to humanity, but more pressing issues such as:
