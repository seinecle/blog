...
- if possible, connect with existing software for the management of datasets and coders. Discovertext is a great software for the annotation of textual datasets, and I am exploring the possibility that the BWS web app I develop can connect to it, which would save on development time and insure a best-in-class management of coders and datasets.
