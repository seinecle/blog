...
The democratization of content production by independent individuals, channels of content distribution and diversification of learning habits (shorter attention spans, mobile first, screen-based...). Would highered orgs be sidelined, since knowledge becomes available for free, easily and from anywhere?

2. [2010 and forward] **Big data and data science**

Personalized learning achieved through the analysis of vast quantities of personal data to create individual learning paths. Is the classroom with standardized teaching at the group-level still relevant? Is the professor relevant as a designer of courses, when the content can be aggregated, curated and assembled from Netflix-like platforms? 
...
I was an active participant in the last 2 of the 3 shocks while a professor at emlyon business school, under the direction of Bernard Belletante. Belletante is a visionary who made sure these shocks were anticipated and translated into the programs and support services of the school. Launch of new programs, Makers lab, new LMS, de-siloting of academic departments, adaptation of the classrooms for hybrid learning, etc: the school rode the wave and served it students so well by making all these changes in advance rather than in reaction to the shocks.
...
I think AI is of a shock of a different kind. Let's state some facts:

 - profound: AI imitates cognitive capabilities to the point it is indistiguishable or better than human performance in significant cases.
 - broad: usage is widespread at school, in the workplace, in our personal lives, in governments and administrations, in arts and culture, in science and technology, in the conduct of war, etc.
