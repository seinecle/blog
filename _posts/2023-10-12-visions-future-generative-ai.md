...
### My personl opinion
I tend to flatly disagree with Chomsky here, which is embarrassing because who am I to disagree with such a great mind. I would think that yes, generative AI is not the same kind of intelligence as a human intelligence. But that does not prove generative AI is incapable of reasoning. It can achieve reasoning trhough different (non biological) means, namely the gigantic number of statistical associations stored in the model that the generative AI is.
